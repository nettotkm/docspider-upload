        ...
        <form className="flex flex-col">
          ...
          <div className="flex items-center justify-center w-full mt-5">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-200 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
            >
              <div className="flex flex-col text-blue-300 items-center justify-center pt-5 pb-6">
                <svg
                  aria-hidden="true"
